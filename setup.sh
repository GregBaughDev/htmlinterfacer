...
./gradlew jlink
mkdir ../HtmlInterfacer_v1.2
touch ../HtmlInterfacer_v1.2/.env
cp -r ./build ../HtmlInterfacer_v1.2
echo "GHOWNER=${GHOWNER}" >> ../HtmlInterfacer_v1.2/.env
echo "GHREPO=${GHREPO}" >> ../HtmlInterfacer_v1.2/.env
echo "OAUTH=${OAUTH}" >> ../HtmlInterfacer_v1.2/.env
echo "FILES=${FILES}" >> ../HtmlInterfacer_v1.2/.env
echo "BASE_BRANCH=${BASE_BRANCH}" >> ../HtmlInterfacer_v1.2/.env

touch ../HtmlInterfacer_v1.2/start.sh
echo "./build/image/bin/com.htmlinterfacer.htmlinterfacer" >> ../HtmlInterfacer_v1.2/start.sh
echo "*****************************************************************************"
echo "Setup complete!"
